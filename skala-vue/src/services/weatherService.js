...
export const DEFAULT_CITIES = [
  { id: 'seoul', name: '서울', engName: 'Seoul', country: '대한민국 🇰🇷', continent: '아시아', lat: 37.5665, lon: 126.978, tag: '남산타워 & 한강' },
  { id: 'suwon', name: '수원', engName: 'Suwon', country: '대한민국 🇰🇷', continent: '아시아', lat: 37.2636, lon: 127.0286, tag: '화성행궁' },
  { id: 'incheon', name: '인천', engName: 'Incheon', country: '대한민국 🇰🇷', continent: '아시아', lat: 37.4563, lon: 126.7052, tag: '송도 센트럴파크' },
  { id: 'busan', name: '부산', engName: 'Busan', country: '대한민국 🇰🇷', continent: '아시아', lat: 35.1796, lon: 129.0756, tag: '해운대 & 광안리' },
  { id: 'daegu', name: '대구', engName: 'Daegu', country: '대한민국 🇰🇷', continent: '아시아', lat: 35.8714, lon: 128.6014, tag: '동성로 & 앞산' },
  { id: 'daejeon', name: '대전', engName: 'Daejeon', country: '대한민국 🇰🇷', continent: '아시아', lat: 36.3504, lon: 127.3845, tag: '엑스포 과학공원' },
  { id: 'gwangju', name: '광주', engName: 'Gwangju', country: '대한민국 🇰🇷', continent: '아시아', lat: 35.1595, lon: 126.8526, tag: '무등산 국립공원' },
  { id: 'ulsan', name: '울산', engName: 'Ulsan', country: '대한민국 🇰🇷', continent: '아시아', lat: 35.5384, lon: 129.3114, tag: '대왕암 공원' },
  { id: 'jeju', name: '제주', engName: 'Jeju', country: '대한민국 🇰🇷', continent: '아시아', lat: 33.4996, lon: 126.5312, tag: '에메랄드 바다' },
  { id: 'gangneung', name: '강릉', engName: 'Gangneung', country: '대한민국 🇰🇷', continent: '아시아', lat: 37.7519, lon: 128.8761, tag: '안목해변 커피거리' },
  { id: 'chuncheon', name: '춘천', engName: 'Chuncheon', country: '대한민국 🇰🇷', continent: '아시아', lat: 37.8854, lon: 127.7298, tag: '소양강 스카이워크' },
  { id: 'jeonju', name: '전주', engName: 'Jeonju', country: '대한민국 🇰🇷', continent: '아시아', lat: 35.8242, lon: 127.148, tag: '한옥마을' },
  { id: 'pohang', name: '포항', engName: 'Pohang', country: '대한민국 🇰🇷', continent: '아시아', lat: 36.019, lon: 129.3435, tag: '호미곶 일출' },
  { id: 'changwon', name: '창원', engName: 'Changwon', country: '대한민국 🇰🇷', continent: '아시아', lat: 35.228, lon: 128.6811, tag: '진해 군항제' },
  { id: 'pyeongchang', name: '평창', engName: 'Pyeongchang', country: '대한민국 🇰🇷', continent: '아시아', lat: 37.3705, lon: 128.3902, tag: '대관령 양떼목장' },
]
...
export const WORLD_DESTINATIONS = [
  // 아시아
  { id: 'seoul', name: '서울', engName: 'Seoul', country: '대한민국 🇰🇷', continent: '아시아', lat: 37.5665, lon: 126.978, tag: '남산타워 & 한강' },
  { id: 'jeju', name: '제주', engName: 'Jeju', country: '대한민국 🇰🇷', continent: '아시아', lat: 33.4996, lon: 126.5312, tag: '에메랄드 바다 & 한라산' },
  { id: 'tokyo', name: '도쿄', engName: 'Tokyo', country: '일본 🇯🇵', continent: '아시아', lat: 35.6762, lon: 139.6503, tag: '신주쿠 & 시부야' },
  { id: 'osaka', name: '오사카', engName: 'Osaka', country: '일본 🇯🇵', continent: '아시아', lat: 34.6937, lon: 135.5023, tag: '도톤보리 & 미식 탐방' },
  { id: 'danang', name: '다낭', engName: 'Danang', country: '베트남 🇻🇳', continent: '아시아', lat: 16.0544, lon: 108.2022, tag: '미케비치 & 바나힐' },
  { id: 'bangkok', name: '방콕', engName: 'Bangkok', country: '태국 🇹🇭', continent: '아시아', lat: 13.7563, lon: 100.5018, tag: '카오산로드 & 야시장' },
  { id: 'bali', name: '발리', engName: 'Bali', country: '인도네시아 🇮🇩', continent: '아시아', lat: -8.4095, lon: 115.1889, tag: '서핑 & 우붓 힐링' },
  { id: 'singapore', name: '싱가포르', engName: 'Singapore', country: '싱가포르 🇸🇬', continent: '아시아', lat: 1.3521, lon: 103.8198, tag: '마리나베이 & 가든스' },
  { id: 'taipei', name: '타이베이', engName: 'Taipei', country: '대만 🇹🇼', continent: '아시아', lat: 25.033, lon: 121.5654, tag: '야시장 & 지우펀' },

  // 유럽
  { id: 'paris', name: '파리', engName: 'Paris', country: '프랑스 🇫🇷', continent: '유럽', lat: 48.8566, lon: 2.3522, tag: '에펠탑 & 루브르 박물관' },
  { id: 'london', name: '런던', engName: 'London', country: '영국 🇬🇧', continent: '유럽', lat: 51.5074, lon: -0.1278, tag: '빅벤 & 타워브릿지' },
  { id: 'rome', name: '로마', engName: 'Rome', country: '이탈리아 🇮🇹', continent: '유럽', lat: 41.9028, lon: 12.4964, tag: '콜로세움 & 바티칸' },
  { id: 'barcelona', name: '바르셀로나', engName: 'Barcelona', country: '스페인 🇪🇸', continent: '유럽', lat: 41.3879, lon: 2.1699, tag: '사그라다 파밀리아' },
  { id: 'interlaken', name: '인터라켄', engName: 'Interlaken', country: '스위스 🇨🇭', continent: '유럽', lat: 46.6863, lon: 7.8632, tag: '융프라우 & 알프스 설경' },
  { id: 'prague', name: '프라하', engName: 'Prague', country: '체코 🇨🇿', continent: '유럽', lat: 50.0755, lon: 14.4378, tag: '카를교 & 구시가지' },
  { id: 'reykjavik', name: '레이캬비크', engName: 'Reykjavik', country: '아이슬란드 🇮🇸', continent: '유럽', lat: 64.1466, lon: -21.9426, tag: '오로라 & 온천' },

  // 아메리카
  { id: 'newyork', name: '뉴욕', engName: 'New York', country: '미국 🇺🇸', continent: '아메리카', lat: 40.7128, lon: -74.006, tag: '타임스퀘어 & 센트럴파크' },
  { id: 'losangeles', name: '로스앤젤레스', engName: 'Los Angeles', country: '미국 🇺🇸', continent: '아메리카', lat: 34.0522, lon: -118.2437, tag: '할리우드 & 산타모니카' },
  { id: 'honolulu', name: '하와이(호놀룰루)', engName: 'Honolulu', country: '미국 🇺🇸', continent: '아메리카', lat: 21.3069, lon: -157.8583, tag: '와이키키 비치 & 휴양' },
  { id: 'vancouver', name: '밴쿠버', engName: 'Vancouver', country: '캐나다 🇨🇦', continent: '아메리카', lat: 49.2827, lon: -123.1207, tag: '스탠리파크 & 항구' },
  { id: 'cancun', name: '칸쿤', engName: 'Cancun', country: '멕시코 🇲🇽', continent: '아메리카', lat: 21.1619, lon: -86.8515, tag: '카리브해 올인클루시브' },

  // 오세아니아
  { id: 'sydney', name: '시드니', engName: 'Sydney', country: '호주 🇦🇺', continent: '오세아니아', lat: -33.8688, lon: 151.2093, tag: '오페라하우스 & 비치' },
  { id: 'melbourne', name: '멜버른', engName: 'Melbourne', country: '호주 🇦🇺', continent: '오세아니아', lat: -37.8136, lon: 144.9631, tag: '그레이트오션로드' },
  { id: 'auckland', name: '오클랜드', engName: 'Auckland', country: '뉴질랜드 🇳🇿', continent: '오세아니아', lat: -36.8485, lon: 174.7633, tag: '와이헤케 아일랜드' },
  { id: 'guam', name: '괌', engName: 'Guam', country: '미국령 🇬🇺', continent: '오세아니아', lat: 13.4443, lon: 144.7937, tag: '투몬비치 & 쇼핑 천국' },
]
